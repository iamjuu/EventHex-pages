      ...
      {fields.map((field, index) => (
        <div
          ...
          style={{
            fontSize: '14px',
            position: 'relative',
            marginBottom: field.type === 'checkbox' ? '16px' : '16px',
          }}
        >
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
            ...
            {field.type !== 'checkbox' ? (
              ...
              >
                ...
                {/* Additional Element: Forgot Password Link */}
                {field.additionalElement?.type === 'link' && (
                  <Link to={field.additionalElement.link}>
                    <span>{field.additionalElement.label}</span>
                  </Link>
                )}
              </div>
            )}
